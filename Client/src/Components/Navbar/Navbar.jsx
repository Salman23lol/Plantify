...
import { FiMenu, FiShoppingCart } from "react-icons/fi"; // Import FiShoppingCart for cart icon
...
const Navbar = () => {
  ...
  useEffect(() => {
    const userDataFromLocalStorage = sessionStorage.getItem("sessionToken");
